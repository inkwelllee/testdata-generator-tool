...
def main():
    ...
    # 创建窗口
    #window = webview.create_window(title='开心果', url='http://localhost:8098', width=initWidth, height=initHeight, x=posX, y=posY, js_api=api, resizable=True, on_top=always_on_top, text_select=False, confirm_close=False, frameless=True, easy_drag=False)
    #window = webview.create_window(title='开心果', url='http://inkwell.top/gen_ui', width=initWidth, height=initHeight, js_api=api, resizable=True, on_top=always_on_top, text_select=False, confirm_close=False, frameless=True, easy_drag=False)
